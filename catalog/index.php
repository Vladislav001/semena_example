...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_META_KEYWORDS" => "TIP_RASTENIYA",
		...
		"FILTER_PROPERTY_CODE" => array("PROMOTION","NEW","TOP_SALES",""),
		...
		"SECTION_TOP_DEPTH" => "99",
		"SEF_FOLDER" => "/catalog/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"","element"=>"#SECTION_CODE_PATH#/#ELEMENT_CODE#/","section"=>"#SECTION_CODE_PATH#/","sections"=>"filter/#SMART_FILTER_PATH#/apply/","smart_filter"=>"#SECTION_CODE_PATH#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
...
);?> <? if ($APPLICATION->GetCurPage(false) == '/catalog/'): ?> <section class="about">
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"",
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/catalog_about.php"
	)
);?> </section>
