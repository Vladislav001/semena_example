...
$MESS ['MF_SOME_ERROR'] = "Произошла ошибка.";

$MESS ['MF_REQ_NAME'] = "Укажите ваше имя.";
$MESS ['MF_REQ_PHONE'] = "Укажите ваш телефон.";
$MESS ['MF_REQ_EMAIL'] = "Укажите ваш email.";
$MESS ['MF_REQ_MESSAGE'] = "Вы не написали сообщение.";
$MESS ['MF_REQ_PROCESSING_PERSONAL_DATA'] = "Необходимо согласиться с обработкой персональных данных";