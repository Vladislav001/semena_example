...
<div class="bx-authform">
	...
	<form name="bform"  class="form" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>">
        ...
        <div class="form__item">
            <input type="text"
                   ...
                   placeholder="<?=Loc::getMessage("MAIN_AUTH_PWD_FIELD_LOGIN")?>"
                   class="input">
        </div>
        ...
        <div class="form__item">
            <input type="text"
                   ...
                   maxlength="255"
                   value=""
                   placeholder="<?=Loc::getMessage("MAIN_AUTH_PWD_FIELD_EMAIL")?>"
                   class="input">
        </div>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="button button--basic form__submit" name="<?= $arResult['FIELDS']['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_PWD_FIELD_SUBMIT');?>" />
		</div>
		...
		<?if ($arResult['AUTH_AUTH_URL'] || $arResult['AUTH_REGISTER_URL']):?>
			...
			<?if ($arResult['AUTH_AUTH_URL']):?>
				<div class="bx-authform-link-container">
					<a href="<?= $arResult['AUTH_AUTH_URL'];?>" class="link_green" rel="nofollow">
			...
			<?if ($arResult['AUTH_REGISTER_URL']):?>
				<div class="bx-authform-link-container">
					<a href="<?= $arResult['AUTH_REGISTER_URL'];?>" class="link_green" rel="nofollow">
