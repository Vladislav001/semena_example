	...
	<form name="bform" class="form" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>">
        ...
        <div class="form__item">
            <input type="text"
                   ...
                   placeholder="<?=Loc::getMessage("MAIN_AUTH_CHD_FIELD_LOGIN")?>"
                   class="input">
        </div>

        <div class="form__item">
            <input type="text"
                   name="<?= $fields['checkword'];?>"
                   maxlength="255"
                   value="<?= \htmlspecialcharsbx($arResult[$fields['checkword']]);?>"
                   placeholder="<?=Loc::getMessage("MAIN_AUTH_CHD_FIELD_CHECKWORD")?>"
                   class="input">
        </div>
		...
		<div class="form__item">
            ...
            <input type="password"
                   ...
                   maxlength="255"
                   value=""
                   placeholder="<?=Loc::getMessage("MAIN_AUTH_CHD_FIELD_PASS")?>"
                   autocomplete="off"
                   class="input">
		</div>
		...
		<div class="form__item">
                ...
                <input type="password"
                       ...
                       maxlength="255"
                       value=""
                       placeholder="<?=Loc::getMessage("MAIN_AUTH_CHD_FIELD_PASS2")?>"
                       autocomplete="off"
                       class="input">
		</div>
		...
		<div class="bx-authform-formgroup-container">
            <input type="submit" class="button button--basic form__submit" name="<?= $fields['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_CHD_FIELD_SUBMIT');?>" />
		</div>
