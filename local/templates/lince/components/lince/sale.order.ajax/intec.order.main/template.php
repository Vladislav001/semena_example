            ...
            <?php } else { ?>
                <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
                    ...
                    <div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
                        <!--	MAIN BLOCK	-->
                        <h1 class="col-sm-12 h1 title">Оформление заказа: Шаг 2 из 2</h1>
                        <div class="col-sm-12 bx-soa">
                            ...
                            <div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
                                <div class="bx-soa-section-title-container">
                                    ...
                                    <div class="red-text"">В строку "Название Вашего города" пишите ТОЛЬКО НАЗВАНИЕ населенного пункта (без г, д, п, с, пгт, обл, р-н и пр.). Затем из выпадающего списка выберите населенный пункт с Вашей областью, районом.</div>
                            ...
                            <div id="bx-soa-orderSave">
                                <div class="bx-soa-orderSave-wrapper">
                                    ...
                                    <div class="bx-soa-orderSave-button">
                                        <a href="javascript:void(0)" style="margin: 10px 0" class="<?/*bx-soa-button bx-soa-button-colored bx-soa-button-lg*/?>button button--basic" data-save-button="true">
                                            <?=$arParams['MESS_ORDER']?>
                                        </a>
                                    </div>
                                </div>
